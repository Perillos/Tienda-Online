...
<body>
    <form method="post" action="/controller/update.user.controler.php?id=<?php echo $id_user; ?>">
        ...
        <div>
            ...
            <input name="dni_letter" type="hidden" id="dni_letter" maxlength="1" value="<?php echo $user_array[5]; ?>" required>
        </div>
